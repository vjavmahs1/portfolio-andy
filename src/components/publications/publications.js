        ...
        return(
            <div className="outer">
                ...
                <div className ="root">
                    ...
                    <Publication body= {"Kim, A. J., & Anderson, B. A. (2019, accepted in principle). The effect of concurrent reward on aversive information processing in the brain. NeuroImage. doi: 10.17605/OSF.IO.56ZGV "}  link = {NeuroImageRR}/>
                    ...
                    <Publication body = {"Huang, C. C., Shi, L., Lin, C. H., Kim, A. J., Ko, M. L., & Ko, G. Y. P. (2015). A new role for AMP‐activated protein kinase in the circadian regulation of L‐type voltage‐gated calcium channels in late‐stage embryonic retinal photoreceptors. Journal of Neurochemistry, 135, 727-741. "} link = {Neurochemistry}/>
                    <Publication body = {"Chang, R. C., Shi, L., Huang, C. C., Kim, A. J., Ko, M. L., Zhou, B., & Ko, G. Y. (2015). High-fat-diet induced retinal dysfunction. Investigative Ophthalmology & Visual Science, 56: 2367-2380."} link={IOVS_2015}/>
                    <Publication body = {"Shi, L., Ko, S., Ko, M. L., Kim, A. J., & Ko, G. Y. (2015). Peptide lv augments L-type voltage- gated calcium channels through vascular endothelial growth factor receptor 2 (VEGFR2) signaling. Biochimica Et Biophysica Acta (BBA)- Molecular Cell Research, 1853(5), 1154-1164."} link = {Biochimica} />
                </div>
